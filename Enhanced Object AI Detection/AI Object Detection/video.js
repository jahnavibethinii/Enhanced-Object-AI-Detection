document.getElementById("Artificial Intelligence").addEventListener("change", toggleAi)
...
function isReady() {
    if (modelIsLoaded && cameraAvailable) {
        ...
        document.getElementById("Artifficial Intelligence").disabled = false;
        return true;
    } else {
        return false;
    }
...
function toggleAi() {
    aiEnabled = document.getElementById("Artificial Intelligence").checked;
}
